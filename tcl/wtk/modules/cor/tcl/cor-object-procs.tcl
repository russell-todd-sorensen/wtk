...
namespace eval ::wtk::cor {

    namespace import -force ::wtk::log::log
}

proc ::wtk::cor::quoteSingleQuotes { string } {
    string map {' ''} $string
}

proc ::wtk::cor::quoteTableComments { string {indents 0} } {
...
proc ::wtk::cor::quoteColumnComments { string {indents 1} } {
...
proc ::wtk::cor::checkStringLength { stringVar max {min 0} } {

    upvar $stringVar VAR
    log Notice "checkStringLength max = $max min = $min"
    return [string length $VAR] >= $min && [string length $VAR] <= $max

}

proc ::wtk::cor::checkStringRegexp { stringVar regexp } {
...
proc ::wtk::cor::checkStringGlob { stringVar glob } {

    upvar $stringVar VAR
    string match $glob $VAR
}

proc ::wtk::cor::checkListLength { listVar max {min 0} } {
...
proc ::wtk::cor::formatConstraints { constraints tableAbbrev colIndent moduleId schemaId {columnName {}} } {
...
proc ::wtk::cor::formatColumnList { colName keyColList } {
...
proc ::wtk::cor::formatForeignKeyConstraint { moduleId schemaId argList } {
